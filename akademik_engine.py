...
K1_MANTIK = [
    ...
    {"id":"k1_l_13","text":"4 arkadaş sırada. Ahmet Zeynep'in solunda. Burak en sağda. Elif Ahmet-Burak arasında. Soldan sıra?","options":{"a":"Zeynep-Ahmet-Elif-Burak","b":"Ahmet-Zeynep-Elif-Burak","c":"Zeynep-Elif-Ahmet-Burak","d":"Ahmet-Elif-Zeynep-Burak"},"answer":"b","difficulty":"zor","skill":"siralama"},
...
K2_OKUMA = [
    ...
    {"passage": "Osmanlı döneminde vakıf sistemi toplumsal dayanışmanın temel kurumlarından biriydi. Varlıklı kişiler camiler, medreseler, kervansaraylar, çeşmeler ve hastaneler inşa ettirerek bunları vakıf yoluyla toplumun hizmetine sunardı. Vakıf gelirleri dükkân, han veya tarım arazisi kiralarından elde edilirdi. Bu gelirlerle kurumların bakımı yapılır, çalışanların maaşları ödenir ve yoksullara yardım edilirdi. Vakıf sistemi devlet bütçesine yük olmadan sosyal hizmetlerin sürdürülmesini sağlayan ileri bir modeldi.",
     "questions": [
        ...
        {"id":"k2_oa_14","text":"Vakıf sisteminin 'ileri bir model' olarak nitelendirilmesinin nedeni nedir?","options":{"a":"Askeri güç sağlaması","b":"Devlet bütçesine yük olmadan toplum hizmeti sunması","c":"Sadece zenginlere hizmet vermesi","d":"Vergi toplama yöntemi olması"},"answer":"b","difficulty":"orta","skill":"cikarim"},
...
K2_MATEMATIK = [
    ...
    {"id":"k2_m_19","text":"A ve B şehirleri arası 240 km. Bir araç A'dan 60 km/sa, diğeri B'den 80 km/sa ile aynı anda hareket ediyor. Kaç saat sonra buluşurlar?","options":{"a":"1,5 sa","b":"≈1,7 sa","c":"2 sa","d":"≈2,5 sa"},"answer":"b","difficulty":"zor","skill":"problem_cozme"},
    {"id":"k2_m_20","text":"f(x)=2x+3 ise f(f(2))=?","options":{"a":"17","b":"15","c":"13","d":"11"},"answer":"a","difficulty":"zor","skill":"cebir"},
]
...
K2_MANTIK = [
    ...
    {"id":"k2_l_14","text":"Satranç tahtasında (8×8) iki köşegen üzerinde toplam kaç kare var?","options":{"a":"14","b":"15","c":"16","d":"8"},"answer":"c","difficulty":"zor","skill":"mantiksal_cikarim"},
...
K3_MANTIK = [
    ...
    {"id":"k3_l_7","text":"A, B, C, D, E beş arkadaş. A, C'den uzun. B, E'den kısa. D en uzun. C, B'den uzun. En kısa kim?","options":{"a":"A","b":"B","c":"C","d":"E"},"answer":"b","difficulty":"orta","skill":"siralama"},
    ...
    {"id":"k3_l_10","text":"Bir algoritma: x ile başla, 2 ile çarp, 1 çıkar. x=4 için 3 kez uygulanırsa sonuç?","options":{"a":"25","b":"29","c":"31","d":"35"},"answer":"a","difficulty":"orta","skill":"mantiksal_cikarim"},
...
K4_MATEMATIK = [
    ...
    {"id":"k4_m_5","text":"10.000 TL %10 bileşik faizle 3 yıl: toplam?","options":{"a":"13.000","b":"13.310","c":"13.100","d":"13.331"},"answer":"b","difficulty":"kolay","skill":"hesaplama"},
...
K4_MANTIK = [
    ...
    {"id":"k4_l_12","text":"Bir otomat kuralı: girdi 0 ise sola git, 1 ise sağa git, başlangıç ortada. Girdi: 0,1,1,0,0,1. Son konum başlangıca göre nerede?","options":{"a":"1 sola","b":"Başlangıçta","c":"1 sağa","d":"2 sola"},"answer":"b","difficulty":"orta","skill":"mantiksal_cikarim"},
